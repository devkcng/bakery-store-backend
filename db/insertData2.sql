...
VALUES
    ...
    (
        ...
        'Phường Bến Thành',
        '0902345678',
        'Giao sau 5 giờ chiều',
        'DELIVERED'
    ),
    (
        'Lê Văn Cao',
        '789 Đường Trường Chinh',
        'Quận Tân Bình',
        'Phường 15',
        '0903456789',
        'Gọi trước khi giao',
    ...
    (
        'Phạm Thị Diệp',
        '135 Đường Hoàng Hoa Thám',
        'Quận Bình Thạnh',
        'Phường 7',
        '0904567890',
        'Giao hàng trong buổi sáng',
        'IN_TRANSIT'
    ),
    (
        'Đỗ Minh Em',
        '246 Đường Cách Mạng Tháng 8',
        'Quận 3',
        'Phường 11',
        '0905678901',
    ...
    (
        'Bùi Văn Pha',
        '357 Đường Điện Biên Phủ',
        'Quận Bình Thạnh',
        'Phường 25',
        '0906789012',
        'Không gọi khi giao hàng',
        'DELIVERED'
    ),
    (
        'Vũ Thị Gióng',
        '468 Đường Hai Bà Trưng',
        'Quận 3',
        'Phường 6',
        '0907890123',
        'Giao hàng sau 6 giờ chiều',
        'IN_TRANSIT'
    ),
    (
        'Ngô Văn Huy',
        '579 Đường Nguyễn Trãi',
        'Quận 5',
        'Phường 8',
        '0908901234',
    ...
    (
        'Trịnh Thị Ý',
        '680 Đường Võ Văn Kiệt',
        'Quận 1',
        'Phường Cô Giang',
        '0909012345',
        'Giao hàng trong buổi chiều',
        'DELIVERED'
    ),
    (
        'Lâm Văn Châu',
        '791 Đường Phan Xích Long',
        'Quận Phú Nhuận',
        'Phường 2',
        '0910123456',
        'Giao trong giờ hành chính',
